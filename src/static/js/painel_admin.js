...
if (estacaoContainer && estacaoExemplo && estacaoToggle) {
  ...
  const weatherCardsData = {
    "24h": [
      { title: '00h', temp: 19, min: 16, max: 27, umidade: 80, vento: 8, chuva: 0 },
      { title: '03h', temp: 18, min: 16, max: 27, umidade: 82, vento: 7, chuva: 0 },
      { title: '06h', temp: 17, min: 16, max: 27, umidade: 85, vento: 6, chuva: 0 },
      { title: '09h', temp: 20, min: 16, max: 27, umidade: 70, vento: 10, chuva: 0 },
      { title: '12h', temp: 24, min: 16, max: 27, umidade: 60, vento: 12, chuva: 0 },
      { title: '15h', temp: 27, min: 16, max: 27, umidade: 55, vento: 14, chuva: 0 },
      { title: '18h', temp: 25, min: 16, max: 27, umidade: 65, vento: 11, chuva: 0 },
      { title: '21h', temp: 22, min: 16, max: 27, umidade: 75, vento: 9, chuva: 0 }
    ],
    semana: [
      { title: 'Seg', temp: 27, min: 16, max: 27, desc: 'Ensolarado', umidade: 60, vento: 10, chuva: 0 },
      { title: 'Ter', temp: 22, min: 16, max: 27, desc: 'Nublado', umidade: 65, vento: 12, chuva: 2 },
      { title: 'Qua', temp: 28, min: 16, max: 27, desc: 'Sol', umidade: 58, vento: 11, chuva: 0 },
      { title: 'Qui', temp: 19, min: 16, max: 27, desc: 'Chuva', umidade: 80, vento: 8, chuva: 10 },
      { title: 'Sex', temp: 24, min: 16, max: 27, desc: 'Nublado', umidade: 70, vento: 9, chuva: 1 },
      { title: 'Sáb', temp: 25, min: 16, max: 27, desc: 'Sol', umidade: 62, vento: 10, chuva: 0 },
      { title: 'Dom', temp: 26, min: 16, max: 27, desc: 'Ensolarado', umidade: 60, vento: 8, chuva: 0 }
    ],
    mes: [
      { title: '01/06', temp: 25, min: 15, max: 28, desc: 'Sol', umidade: 60, vento: 10, chuva: 0 },
      { title: '05/06', temp: 23, min: 14, max: 27, desc: 'Nublado', umidade: 65, vento: 12, chuva: 2 },
      { title: '10/06', temp: 21, min: 13, max: 26, desc: 'Chuva', umidade: 80, vento: 8, chuva: 10 },
      { title: '15/06', temp: 27, min: 16, max: 29, desc: 'Ensolarado', umidade: 58, vento: 11, chuva: 0 },
      { title: '20/06', temp: 28, min: 17, max: 30, desc: 'Sol', umidade: 62, vento: 10, chuva: 0 },
      { title: '25/06', temp: 22, min: 15, max: 27, desc: 'Nublado', umidade: 70, vento: 9, chuva: 1 },
      { title: '30/06', temp: 26, min: 16, max: 28, desc: 'Sol', umidade: 60, vento: 8, chuva: 0 }
    ]
  };
  ...
  function updateWeatherMain() {
    ...
    document.getElementById('weatherHumidity').textContent = climaAtual.umidade + '%';
    document.getElementById('weatherWind').textContent = climaAtual.vento + 'km/h';
...
function renderValvulas() {
  ...
  Array.from(assets.querySelectorAll('.valvulas-row')).forEach(r => r.remove());
  Array.from(assets.querySelectorAll('.valvula-box')).forEach(b => b.remove());
  ...
  const boxes = valvulas.map(valvula => {
    ...
    box.innerHTML = `
      ...
      <img class="mdi-valve" id="imgValvula${valvula.id}" src="static/img/${valvula.ativada ? 'mdi--valve-open.svg' : 'mdi--valve.svg'}" />
  ...
  if (valvulasExemplo) {
    containerWidth = valvulasExemplo.clientWidth || valvulasExemplo.offsetWidth || 1080;
  }
...
function setupValvula(id) {
  ...
  btn.onclick = function() {
    img.classList.remove('valve-rotate-in', 'valve-rotate-out', 'valve-rotate-in-reverse', 'valve-rotate-out-reverse');
    if (!valvula.ativada) {
  ...
  saveBtn.onclick = function() {
    ...
    if (novoNome === '') {
      showConfirmModal('Deseja realmente excluir esta válvula?', () => {
        ...
        document.querySelectorAll('.valvula-box').forEach(b => b.style.display = '');
      });
      return;
    }
